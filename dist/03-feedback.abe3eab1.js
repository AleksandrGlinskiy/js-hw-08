...
form.addEventListener('input', (0, _lodash.default)(setDataToLocaleStorage, 500));
...
function getDataFromLocalStorage() {
  ...
  var email = document.querySelector('.feedback-form input');
  var message = document.querySelector('.feedback-form textarea');
  if (data) {
